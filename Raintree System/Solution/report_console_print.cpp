...
//			cout<<endl;
        ...
        //Date Display
        cout<<date_name(dirname);cout<<"\n";
        
		//Storing Drops on Particular Date
		cout<<"Computer Name     No of Drops\n";
		sort(comp,comp+q,compare1);
		for(int ii=0;ii<q;ii++){
			if(comp[ii].drop==0)break;
			cout<<comp[ii].nam<<" "<<comp[ii].drop<<"\n";
		}
		cout<<"\n";
		
		//Storing Disconnects on Particular Date
		cout<<"Computer Name     No of Disconnects\n";
		sort(comp,comp+q,compare2);
		for(int ii=0;ii<q;ii++){
			if(comp[ii].disconnect==0)break;
			cout<<comp[ii].nam<<" "<<comp[ii].disconnect<<"\n";
		}
		cout<<"\n";
		
		//Storing Average on Particular Date
		cout<<"Computer Name     No of Average Limit\n";
		sort(comp,comp+q,compare3);
		for(int ii=0;ii<q;ii++){
			if(comp[ii].avg==0)break;
			cout<<comp[ii].nam<<" "<<comp[ii].avg<<"\n";
		}
		cout<<"\n";
